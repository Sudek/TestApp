...
import ikko_ikki.testapp.presenter.StationFromPresenterImpl;
import ikko_ikki.testapp.view.adapter.StationAdapter;

public class StationFromActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, StationFromView {

    private List<StationFrom> stationFrom;
    private RecyclerView recyclerView;
    private Context context;
    private StationFromPresenterImpl fromPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fromPresenter = new StationFromPresenterImpl();

        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        stationFrom = fromPresenter.getStationFromInfo(context);
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        StationAdapter adapter = new StationAdapter(
                fromPresenter.getFilteredStationList(newText, stationFrom),
    ...
    public void intentSourceCity(String station) {
        ...
        i.putExtra("stationFrom", station);
        setResult(0, i);
        finish();
    }
    //info about station
